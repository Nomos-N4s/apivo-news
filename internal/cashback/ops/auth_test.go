...
func probe(t *testing.T, auth ops.OperatorAuthenticator, authorization string) *httptest.ResponseRecorder {
	...
	ops.NewHandler(discardLogger(), unreachableStore{}, unreachableApprover{}, unreachableRefuser{}, unreachableSettler{}, unreachableReconciliation{}, unreachableHeld{}, auth).ServeHTTP(rec, req)
	return rec
}
