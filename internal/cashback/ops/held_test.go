...
func review(t *testing.T, held ops.HeldReviewer, method, path, body string) *httptest.ResponseRecorder {
	...
	ops.NewHandler(discardLogger(), unreachableStore{}, unreachableApprover{}, unreachableRefuser{}, unreachableSettler{}, unreachableReconciliation{}, held, unreachableDestinations{}, unreachableAwaiting{}, stubAuth{op: anOperator}).ServeHTTP(rec, req)
	return rec
}
