...
func TestAnOmittedAndAShortedTransactionAreFlaggedAndMoveNoMoney(t *testing.T) {
	...
	each(ctx, t, tx, "US6", func(t *testing.T, tx pgx.Tx, store *ops.PGStore) {
		...
		h := ops.NewHandler(discardLogger(), unreachableStore{}, unreachableApprover{}, unreachableRefuser{}, unreachableSettler{}, store, unreachableHeld{}, unreachableDestinations{}, unreachableAwaiting{}, unreachableNetworks{}, stubAuth{op: parties.operator})
