...
func (s *withdrawalStore) UpdateSource(context.Context, uuid.UUID, uuid.UUID, editorial.SourcePatch) (editorial.ListedSource, error) {
	return editorial.ListedSource{}, errUnexpectedCall
}

func (s *withdrawalStore) DeleteSource(context.Context, uuid.UUID) error {
