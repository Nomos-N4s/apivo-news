...
#
# Machine-generated code (the sqlc output under internal/content/store) is
# excluded from the computation: coverage there measures the generator, not
# our tests. The generated queries are exercised by integration tests either
# way.
set -eu
...
grep -v -E '/internal/content/store/' "$PROFILE" > "$PROFILE.filtered"
