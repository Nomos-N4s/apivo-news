 ...
 */
export const FRONT_FIXTURES: readonly ArticleDetail[] = [
  // — Greek reading language —
  {
    ...
    extract:
      'Η απόφαση προσθέτει έντεκα στάσεις στο δυτικό άκρο της πόλης και δεσμεύει χρηματοδότηση έως το 2031. Οι εργασίες αναμένεται να ξεκινήσουν την άνοιξη, με το πρώτο τμήμα να ανοίγει σταδιακά.\n\nΣύμβουλοι από τρία κόμματα χαρακτήρισαν την τετραετή εξέταση ασυνήθιστα μακρά· ο συγκοινωνιακός φορέας απέδωσε την καθυστέρηση στην αναθεωρημένη χάραξη γύρω από τη δυτική βιομηχανική ζώνη.',
    lang: 'el',
    places: ['munich'],
    attribution:
  ...
  },
  {
    ...
    approved_at: '2026-08-14T06:44:00Z',
  },
  {
    ...
    approved_at: '2026-08-14T05:58:00Z',
  },
  {
  ...
  },
  {
    ...
    approved_at: '2026-08-14T05:16:00Z',
  },
  {
    ...
    approved_at: '2026-08-14T04:52:00Z',
  },
  ...
  // — German reading language: the same pipeline, the other axis value —
  {
    ...
    extract:
      'Der Beschluss ergänzt elf Haltestellen am westlichen Stadtrand und sichert die Finanzierung bis 2031. Der Bau soll im Frühjahr beginnen.\n\nStadträte aus drei Fraktionen nannten die vierjährige Prüfung ungewöhnlich lang; der Verkehrsverbund führte die Verzögerung auf die geänderte Trasse um das westliche Gewerbegebiet zurück.',
    lang: 'de',
    places: ['munich'],
    attribution:
