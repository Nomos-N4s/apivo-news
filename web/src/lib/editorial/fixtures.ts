...
export const SOURCE_FIXTURES: readonly SourceRow[] = [
  {
    ...
    language: 'de',
    jurisdiction: 'DE',
    licence_terms: 'Auszug und Verlinkung mit Quellenangabe gestattet, per Feed-Bedingungen v2.',
  ...
  },
  {
    ...
    language: 'de',
    jurisdiction: 'DE',
    licence_terms: 'Auszug und Verlinkung mit Quellenangabe gestattet, per Feed-Bedingungen v1.',
    usage_rule: 'extract_and_link',
    permission_evidence: null,
    active: true,
  ...
  },
  {
    ...
    language: 'de',
    jurisdiction: 'DE',
    licence_terms: 'Auszug und Verlinkung gestattet; keine Volltextübernahme.',
    usage_rule: 'extract_and_link',
    permission_evidence: null,
    active: true,
  ...
  },
  {
    ...
    language: 'el',
    jurisdiction: 'GR',
    licence_terms: 'Επιτρέπεται απόσπασμα και σύνδεσμος με αναφορά πηγής, όροι ροής v1.',
    usage_rule: 'extract_and_link',
    permission_evidence: null,
    active: true,
  ...
  },
  {
    ...
    language: 'el',
    jurisdiction: 'GR',
    licence_terms: 'Επιτρέπεται απόσπασμα και σύνδεσμος με αναφορά πηγής, όροι ροής v3.',
    usage_rule: 'extract_and_link',
    permission_evidence: null,
    active: false,
    last_polled_at: null,
